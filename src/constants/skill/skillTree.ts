...
import type { Archetype, SkillTreeDef } from "@/types/skillTree";
...
export const SKILL_TREES: Record<Class, SkillTreeDef[]> = {
...
export const ARCHETYPE_COLORS: Record<Archetype, string> = {
  [ARCHETYPE.WARRIOR_A]: "var(--red-400)",
  [ARCHETYPE.WARRIOR_B]: "var(--blue-400)",
  [ARCHETYPE.ARCHER_A]: "var(--emerald-400)",
  [ARCHETYPE.ARCHER_B]: "var(--lavender-400)",
  [ARCHETYPE.MAGE_A]: "var(--red-orange-400)",
  [ARCHETYPE.MAGE_B]: "var(--cyan-300)",
  [ARCHETYPE.ROGUE_A]: "var(--amber-400)",
  [ARCHETYPE.ROGUE_B]: "var(--neutral-800)",
};
