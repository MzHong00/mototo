...
import { BOSS_TYPE, BOSS_STATS, BOSS_REWARD_ITEM } from "@/constants/boss";
...
interface RedGuardianBossProps {
  onBossDeath: () => void;
}

const SPAWN_POSITION: [number, number, number] = [0, 1.25, -8];

export function RedGuardianBoss({ onBossDeath }: RedGuardianBossProps) {
