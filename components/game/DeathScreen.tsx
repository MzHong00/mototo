...
export function DeathScreen({ onRespawn }: DeathScreenProps) {
  return (
    <div style={{
      ...
      <div style={{ fontFamily: "var(--font-title)", fontWeight: 600, fontSize: 42, color: "#FF4444", textShadow: "0 0 30px rgba(255,68,68,0.8)", marginBottom: 12 }}>
        쓰러졌습니다
      </div>
      <div style={{ fontFamily: "var(--font-ui)", fontSize: 14, color: "rgba(255,255,255,0.5)", marginBottom: 48 }}>
        몬스터에게 처치당했습니다
      </div>
      ...
      <button
        onClick={onRespawn}
        style={{
          fontFamily: "var(--font-ui)", fontWeight: 900, fontSize: 15,
          padding: "12px 40px",
